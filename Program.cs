...
namespace Practice_3
{
     class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            void Task3()
            {
                Console.WriteLine("Please enter the full path to the directory of your image\r\n");
                string filepath = Console.ReadLine();
                Console.Clear();
                Console.WriteLine("Please enter the full path to the directory where edited images will be saved\r\n");
                string newfilepath = Console.ReadLine();
                Console.Clear();
                List<Bitmap> images = LoadImages(filepath);
                ...
                Action<Bitmap, RotateFlipType> imageOperations = (Bitmap x, RotateFlipType y) => x.RotateFlip(y);
